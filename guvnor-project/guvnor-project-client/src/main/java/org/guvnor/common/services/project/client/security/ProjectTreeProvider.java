...
public class ProjectTreeProvider implements PermissionTreeProvider {
    ...
    @Inject
    public ProjectTreeProvider(final PermissionManager permissionManager,
                               final Caller<ProjectSearchService> searchService) {
    ...
    private PermissionNode toPermissionNode(final Project p) {
