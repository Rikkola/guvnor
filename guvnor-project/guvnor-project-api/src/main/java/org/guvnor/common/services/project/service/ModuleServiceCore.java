...
public interface ModuleServiceCore<T> {
    ...
    /**
     * Gets all the modules from a given branch. Security checks are omitted.
    ...
    /**
     * Gets a list of the projects in a particular branch. Security checks are applied.
     * @param branch the branch where we are looking for the modules
     * @return
     */
    Set<Module> getModules(final Branch branch );
