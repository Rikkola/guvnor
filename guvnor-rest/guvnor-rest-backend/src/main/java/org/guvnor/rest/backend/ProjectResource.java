...
public class ProjectResource {
    ...
    public Response createProject(
        ...
        logger.debug("-----createProject--- , organizationalUnitName: {} , project name: {}",
                     ...
                     project.getName());
        checkRepositoryExistence(organizationalUnitName);
    ...
    public Collection<ProjectResponse> getProjects() {
        ...
        final Collection<Project> projects = projectService.getAllProjects();
    ...
    private org.guvnor.structure.repositories.Repository checkRepositoryExistence(final String repoName) {
