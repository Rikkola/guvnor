...
public class ACLMigrationToolTest {
    ...
    public void setUp() {
        ...
        when(projectService.getAllProjects(orgUnit1)).thenReturn(Collections.singleton(project1));
        when(projectService.resolveProject(repo1root)).thenReturn(project1);
        ...
        when(project1.getMainModule()).thenReturn(module1);
