...
public class ExplorerNodeConfig {
    ...
    public static void setupCategoriesStructure(IsTreeItem byCategory, final Map<TreeItem, String> itemWidgets) {
        doCategoryNode(byCategory, "/", itemWidgets);
    }

    private static void doCategoryNode(final IsTreeItem treeItem, final String path, final Map<TreeItem, String> itemWidgets) {
    ...
    private static GenericCallback<String[]> createGenericCallbackForLoadChildCategories(final IsTreeItem treeItem, final String path, final Map<TreeItem, String> itemWidgets) {
        return new GenericCallback<String[]>() {
            ...
            private void createChildNodes(final IsTreeItem treeItem, final String path, final Map<TreeItem, String> itemWidgets, String[] value) {
                for (int i = 0; i < value.length; i++) {
                    ...
                    treeItem.asTreeItem().addItem(childNode);
    ...
    private static void infanticide(final IsTreeItem treeNode) {
        treeNode.asTreeItem().removeItems();
    }

    public static void setupStatesStructure(final IsTreeItem byStatus, final Map<TreeItem, String> itemWidgets) {
        RepositoryServiceFactory.getService().listStates(new GenericCallback<String[]>() {
            public void onSuccess(String[] value) {
                for (int i = 0; i < value.length; i++) {
                    ...
                    itemWidgets.put(childNode, widgetID);
                    byStatus.asTreeItem().addItem(childNode);
                }
            }
        });
    }
