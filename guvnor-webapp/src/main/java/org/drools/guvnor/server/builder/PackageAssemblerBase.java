...
abstract class PackageAssemblerBase extends AssemblerBase {
    ...
    private StringBuilder getAllFunctionsAsOneString() {
        AssetItemIterator functionsIterator = getAssetItemIterator(AssetFormats.FUNCTION);
    ...
    private void loadDeclaredTypes() {
        AssetItemIterator declaredTypesIterator = getAssetItemIterator(AssetFormats.DRL_MODEL);
